...
public class MoleScript : MonoBehaviour
{
    ...
    private bool Badger()
    {
        ...
        {
            Debug.LogFormat("[That's The Mole #{0}] Module solved.", _id, CardsRight.Count);
        ...
        {
            Debug.LogFormat("[That's The Mole #{0}] You submitted {1}. Strike!", _id, Cards.Count - CardsRight.Count);
            Module.HandleStrike();
        }
        return false;
    }
